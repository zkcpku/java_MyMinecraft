...
public class GraphItem extends GameItem {
    ...
    private final PicTexture fontTexture;

    private String text;

    public GraphItem(String text, PicTexture fontTexture) throws Exception {
        super();
        this.text = text;
    ...
    private Mesh buildMesh() {
        ...
        for(int i=0; i<numChars; i++) {
            PicTexture.CharInfo charInfo = fontTexture.getCharInfo(characters[i]);
